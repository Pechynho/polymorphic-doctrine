...
final readonly class PolymorphicEventListener
{
    ...
    private function setIndexes(GenerateSchemaTableEventArgs $args): void
    {
        ...
        $entityClass = $doctrineClassMetadata->getName();
        $polymorphicClassMetadata = $this->metadataProvider->getClassMetadata($entityClass);
        if (!$polymorphicClassMetadata instanceof Model\ClassMetadata) {
            return;
        }
    ...
    public function postLoad(PostLoadEventArgs $args): void
    {
        ...
        if (!$classMetadata instanceof Model\ClassMetadata) {
            return;
        }
